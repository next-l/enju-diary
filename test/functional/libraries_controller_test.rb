...
class LibrariesControllerTest < ActionController::TestCase
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post :create, library: { address: @library.address, name: @library.name, telephone_number: @library.telephone_number }
    end
  ...
  test "should update library" do
    put :update, id: @library, library: { address: @library.address, name: @library.name, telephone_number: @library.telephone_number }
    assert_redirected_to library_path(assigns(:library))
  end
